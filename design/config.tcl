...
# Change if needed
set ::env(VERILOG_FILES) [glob $::env(DESIGN_DIR)/src/rvmyth_avsddac.v]
set ::env(LIB_SYNTH) [glob $::env(DESIGN_DIR)/src/sky130_fd_sc_hd__tt_025C_1v80.lib]
set ::env(SYNTH_READ_BLACKBOX_LIB) "1"
set ::env(EXTRA_LIBS) [glob $::env(DESIGN_DIR)/src/avsddac.lib]
